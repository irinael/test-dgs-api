...
describe('ValidationService', () => {
  ...
  it('should check movements in a given months - check KO', () => {
    ...
    expect(response.failReasons).toContainEqual({
      ...
      message: 'Une ou des opérations manquantes sur cette période',
      amountOff: -100,
      duplicatedMovements: [],
    });
  });
  ...
  it('should check movements in a given year - check KO - duplicated movement', () => {
    //given movements in a year with on duplicated in december
    const movements: Movement[] = [
      { id: 1, date: new Date('2020-1-2 GMT'), wording: 'op1', amount: 500 },
      { id: 2, date: new Date('2020-1-15 GMT'), wording: 'op2', amount: -200 },
      { id: 3, date: new Date('2020-1-30 GMT'), wording: 'op3', amount: 300 },
    ...
    expect(response.failReasons).toContainEqual({
      ...
      message: 'Le montant des opérations est supérieur au solde attendu',
      amountOff: 600,
      duplicatedMovements: [
        {
          id: 12,
  ...
  it('should check movements in a given year - check KO - duplicated movements id different periods', () => {
    //given movements in a year with on duplicated in december
    const movements: Movement[] = [
      { id: 1, date: new Date('2020-1-2 GMT'), wording: 'op1', amount: 500 },
      { id: 2, date: new Date('2020-1-15 GMT'), wording: 'op2', amount: -200 },
